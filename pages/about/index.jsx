...
export const aboutData = [
	...
	},
	{
		...
		info: [
			{
				title: 'Completed multiple real-world projects',
				// stage: '2011 - 2012',
			},
			{
				title: 'Built full-stack applications independently',
				// stage: '2009 - 2010',
			},
			{
	...
	},
	{
		...
		info: [
			...
			{
				title: 'Strong foundation in React & Next.js',
				// stage: '2009',
			},
			{
				title: 'Comfortable with REST APIs & Git workflow',
				// stage: '2006',
			},
		],
	},
...
const About = () => {
	...
	return (
		<div className="h-full bg-lightPrimary dark:bg-primary/30 py-32 text-center xl:text-left transition-colors duration-300">
			<Circles />
			...
			<div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
				...
				<div className="flex-1 flex flex-col justify-center">
					<motion.h2 variants={fadeIn('right', 0.2)} initial="hidden" animate="show" exit="hidden" className="h2">
						Building fast <br /> <span className="text-accent">modern</span> and scalable <br /> web applications.
					</motion.h2>
					...
					<motion.div variants={fadeIn('right', 0.6)} initial="hidden" animate="show" className="hidden md:flex md:max-w-xl xl:max-w-none mx-auto xl:mx-0 mb-8">
						<div className="flex flex-1 xl:gap-x-6">
							...
							<div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0">
								...
								<div className="text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px]">Projects Built.</div>
							</div>
							...
							<div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0">
								...
								<div className="text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px]">Years Experience.</div>
							</div>

							{/* awards */}
							<div className="relative flex-1">
								<div className="text-2xl xl:text-4xl font-extrabold text-accent mb-2">∞</div>
								<div className="text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px]">Learning Mindset.</div>
							</div>
						</div>
					</motion.div>
				</div>
				...
				<motion.div variants={fadeIn('left', 0.4)} initial="hidden" animate="show" exit="hidden" className="flex flex-col w-full xl:max-w-[48%] h-[480px]">
					...
					<div className="py-2 xl:py-6 flex flex-col gap-y-2 xl:gap-y-4 items-center xl:items-start">
						{aboutData[index].info.map((item, itemI) => (
							<div key={itemI} className="flex-1 flex flex-col md:flex-row max-w-max gap-x-2 items-center text-center text-white/80 dark:text-white/60">
								{/* title */}
								<div className="font-light mb-2 md:mb-0">{item.title}</div>
								{item.icons || item.stage ? <div className="hidden md:flex">-</div> : null}
								<div>{item.stage}</div>
